...
<head>
    ...
    <title>Blood Donor Management System | Become A Donor</title>
...
$sql = "SELECT * from tblblooddonars where (status=:status and BloodGroup=:bloodgroup) ||  (Address=:location and BloodGroup=:bloodgroup)";
$query = $dbh -> prepare($sql);
