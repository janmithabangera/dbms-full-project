...
<head>
	...
	<title>Blood Donor Management System | Donor List  </title>
...
{?>
<a href="donor-list.php?hidden=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to hiidden this detail')"> Hide</a> 
<?php } else {?>
